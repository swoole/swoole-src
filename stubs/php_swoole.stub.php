...
function swoole_async_set(array $settings): bool|void
{
}
...
function swoole_coroutine_defer(callable $callback): bool|void
{
}
...
function swoole_test_kernel_coroutine(int $count = 100, float $sleep_time = 1.0): bool|void
{
}
...
function swoole_error_log(int $level, string $msg): void|bool
{
}

function swoole_error_log_ex(int $level, int $error, string $msg): void|bool
{
}

function swoole_ignore_error(int $error): void|bool
{
}
...
function swoole_mime_type_set(string $suffix, string $mime_type): void|bool
{
}
