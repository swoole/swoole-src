...
namespace Swoole {
    final class Server {
        ...
        public function on(mixed $event_name, mixed $callback): bool {}
        public function getCallback(mixed $event_name): Closure|string|null|array {}
        ...
        public function send(mixed $fd, mixed $send_data, int $serverSocket = -1): bool {}
        ...
        public function sendwait(int $conn_fd, mixed $send_data): bool {}
        ...
        public function taskWaitMulti(mixed $tasks, float $timeout = 0.5): bool|array {}
...
namespace Swoole\Server {
    final class Task {
        public function finish(mixed $data): bool {}
        public function pack(mixed $data): string|bool {}
