...
namespace Swoole\WebSocket {
	class Server {
		...
		public function pack(string $data, int $opcode = WEBSOCKET_OPCODE_TEXT, int $flags = SWOOLE_WEBSOCKET_FLAG_FIN): string {}
		public function unpack(string $data): Frame|bool {}
		public static function pack(string $data, int $opcode = WEBSOCKET_OPCODE_TEXT, int $flags = SWOOLE_WEBSOCKET_FLAG_FIN): string {}
        public static function unpack(string $data): Frame|bool {}
