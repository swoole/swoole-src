...
PHP_MINIT_FUNCTION(swoole)
{
     ...
     * mode type
     */
    SW_REGISTER_LONG_CONSTANT("SWOOLE_MODE_BASE", SW_MODE_BASE);
    SW_REGISTER_LONG_CONSTANT("SWOOLE_MODE_PROCESS", SW_MODE_PROCESS);

    /**
     * task ipc mode
     */
    SW_REGISTER_LONG_CONSTANT("SWOOLE_TASK_IPC_UNIXSOCK", SW_TASK_IPC_UNIXSOCK);
    SW_REGISTER_LONG_CONSTANT("SWOOLE_TASK_IPC_MSGQUEUE", SW_TASK_IPC_MSGQUEUE);
    SW_REGISTER_LONG_CONSTANT("SWOOLE_TASK_IPC_PREEMPTIVE", SW_TASK_IPC_PREEMPTIVE);
    ...
    SW_REGISTER_LONG_CONSTANT("SWOOLE_FLAG_SYNC", SW_FLAG_SYNC);
    SW_REGISTER_LONG_CONSTANT("SWOOLE_FLAG_ASYNC", SW_FLAG_ASYNC);
    SW_REGISTER_LONG_CONSTANT("SWOOLE_FLAG_KEEP", SW_FLAG_KEEP);

#ifdef SW_USE_OPENSSL
    SW_REGISTER_LONG_CONSTANT("SWOOLE_SOCK_SSL", SW_SOCK_SSL);
