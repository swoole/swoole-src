...
PHP_MINIT_FUNCTION(swoole)
{
     ...
     * socket option
     */
    REGISTER_LONG_CONSTANT("SWOOLE_SO_REUSEADDR", SW_SO_REUSEADDR, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("SWOOLE_SO_REUSEPORT", SW_SO_REUSEPORT, CONST_CS | CONST_PERSISTENT);
