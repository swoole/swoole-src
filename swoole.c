...
PHP_MINIT_FUNCTION(swoole)
{
     ...
     * mode type
     */
    SWOOLE_DEFINE(MODE_BASE);
    SWOOLE_DEFINE(MODE_PROCESS);

    /**
     * task ipc mode
     */
    SWOOLE_DEFINE(TASK_IPC_UNIXSOCK);
    SWOOLE_DEFINE(TASK_IPC_MSGQUEUE);
    SWOOLE_DEFINE(TASK_IPC_PREEMPTIVE);

    /**
     * socket type
     */
    SWOOLE_DEFINE(SOCK_TCP);
    SWOOLE_DEFINE(SOCK_TCP6);
    SWOOLE_DEFINE(SOCK_UDP);
    SWOOLE_DEFINE(SOCK_UDP6);
    SWOOLE_DEFINE(SOCK_UNIX_DGRAM);
    SWOOLE_DEFINE(SOCK_UNIX_STREAM);
     ...
     * simple api
     */
    SWOOLE_DEFINE(SOCK_SYNC);
    SWOOLE_DEFINE(SOCK_ASYNC);

    SWOOLE_DEFINE(FLAG_SYNC);
    SWOOLE_DEFINE(FLAG_ASYNC);
    SWOOLE_DEFINE(FLAG_KEEP);

#ifdef SW_USE_OPENSSL
    SWOOLE_DEFINE(SOCK_SSL);

    /**
     * SSL method
     */
    SWOOLE_DEFINE(SSLv3_METHOD);
    SWOOLE_DEFINE(SSLv3_SERVER_METHOD);
    SWOOLE_DEFINE(SSLv3_CLIENT_METHOD);
    SWOOLE_DEFINE(SSLv23_METHOD);
    SWOOLE_DEFINE(SSLv23_SERVER_METHOD);
    SWOOLE_DEFINE(SSLv23_CLIENT_METHOD);
    SWOOLE_DEFINE(TLSv1_METHOD);
    SWOOLE_DEFINE(TLSv1_SERVER_METHOD);
    SWOOLE_DEFINE(TLSv1_CLIENT_METHOD);
#ifdef TLS1_1_VERSION
    SWOOLE_DEFINE(TLSv1_1_METHOD);
    SWOOLE_DEFINE(TLSv1_1_SERVER_METHOD);
    SWOOLE_DEFINE(TLSv1_1_CLIENT_METHOD);
#endif
#ifdef TLS1_2_VERSION
    SWOOLE_DEFINE(TLSv1_2_METHOD);
    SWOOLE_DEFINE(TLSv1_2_SERVER_METHOD);
    SWOOLE_DEFINE(TLSv1_2_CLIENT_METHOD);
#endif
    SWOOLE_DEFINE(DTLSv1_METHOD);
    SWOOLE_DEFINE(DTLSv1_SERVER_METHOD);
    SWOOLE_DEFINE(DTLSv1_CLIENT_METHOD);
#endif

    SWOOLE_DEFINE(EVENT_READ);
    SWOOLE_DEFINE(EVENT_WRITE);
