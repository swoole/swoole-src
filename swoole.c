...
#ifdef SW_USE_QUIC
    REGISTER_LONG_CONSTANT("SWOOLE_SOCK_QUIC", SW_SOCK_QUIC, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("SWOOLE_SOCK_QUIC6", SW_SOCK_QUIC6, CONST_CS | CONST_PERSISTENT);
#endif
...
#ifdef SW_USE_QUIC
    REGISTER_LONG_CONSTANT("SWOOLE_QUIC", SW_SOCK_QUIC, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("SWOOLE_QUIC6", SW_SOCK_QUIC6, CONST_CS | CONST_PERSISTENT);
#endif
