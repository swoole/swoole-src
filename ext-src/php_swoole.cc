...
PHP_MINIT_FUNCTION(swoole) {
    ...
    for (size_t i = 0; i < sizeof(debug_zend_extension_names) / sizeof(debug_zend_extension_names[0]); i++) {
    ...
    for (size_t i = 0; i < sizeof(debug_php_extension_names) / sizeof(debug_php_extension_names[0]); i++) {
