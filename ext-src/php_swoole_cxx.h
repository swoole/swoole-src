...
SW_API zend_object *php_swoole_create_socket_from_fd(swSocketFd fd, enum swSocketType type);
...
SW_API zend_object *php_swoole_dup_socket(swSocketFd fd, enum swSocketType type);
