...
static void thread_register_stdio_file_handles(bool no_close) {
    ...
    if (no_close) {
        ...
        /**
         * However, this approach prevents fd from being closed automatically when the thread exits,
         * resulting in fd leaks. Therefore, each fd must be saved and closed manually after request
         * shutdown to avoid fd leaks.
         */
        bool casted = true;
