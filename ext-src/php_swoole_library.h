...
static const char* swoole_library_source_core_name_service_resolver =
    "\n"
    "\n"
...
void php_swoole_load_library()
{
    ...
    zend::eval(swoole_library_source_core_name_service_resolver, "@swoole-src/library/core/NameService/Resolver.php");
