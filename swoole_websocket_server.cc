...
void swoole_websocket_init(int module_number)
{
    ...
    zend_declare_property_null(swoole_http_server_ce_ptr, ZEND_STRL("onHandshake"), ZEND_ACC_PRIVATE);
    ...
    /* {{{ swoole namespace */
    // status
    SWOOLE_DEFINE_NS(WEBSOCKET_STATUS_CONNECTION);
    SWOOLE_DEFINE_NS(WEBSOCKET_STATUS_HANDSHAKE);
    SWOOLE_DEFINE_NS(WEBSOCKET_STATUS_ACTIVE);
    SWOOLE_DEFINE_NS(WEBSOCKET_STATUS_CLOSING);
    // all opcodes
    SWOOLE_DEFINE_NS(WEBSOCKET_OPCODE_CONTINUATION);
    SWOOLE_DEFINE_NS(WEBSOCKET_OPCODE_TEXT);
    SWOOLE_DEFINE_NS(WEBSOCKET_OPCODE_BINARY);
    SWOOLE_DEFINE_NS(WEBSOCKET_OPCODE_CLOSE);
    SWOOLE_DEFINE_NS(WEBSOCKET_OPCODE_PING);
    SWOOLE_DEFINE_NS(WEBSOCKET_OPCODE_PONG);
    // close error
    SWOOLE_DEFINE_NS(WEBSOCKET_CLOSE_NORMAL);
    SWOOLE_DEFINE_NS(WEBSOCKET_CLOSE_GOING_AWAY);
    SWOOLE_DEFINE_NS(WEBSOCKET_CLOSE_PROTOCOL_ERROR);
    SWOOLE_DEFINE_NS(WEBSOCKET_CLOSE_DATA_ERROR);
    SWOOLE_DEFINE_NS(WEBSOCKET_CLOSE_STATUS_ERROR);
    SWOOLE_DEFINE_NS(WEBSOCKET_CLOSE_ABNORMAL);
    SWOOLE_DEFINE_NS(WEBSOCKET_CLOSE_MESSAGE_ERROR);
    SWOOLE_DEFINE_NS(WEBSOCKET_CLOSE_POLICY_ERROR);
    SWOOLE_DEFINE_NS(WEBSOCKET_CLOSE_MESSAGE_TOO_BIG);
    SWOOLE_DEFINE_NS(WEBSOCKET_CLOSE_EXTENSION_MISSING);
    SWOOLE_DEFINE_NS(WEBSOCKET_CLOSE_SERVER_ERROR);
    SWOOLE_DEFINE_NS(WEBSOCKET_CLOSE_TLS);
    /* swoole namespace }}} */
