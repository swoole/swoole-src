<?php
$serv = swoole_server_create("127.0.0.1", 9500, SWOOLE_PROCESS, SWOOLE_SOCK_TCP);
...
{
    // echo "Server£ºonShutdown\n";
}

function my_onTimer($serv, $interval)
{
    // echo "Server£ºTimer Call.Interval=$interval \n";
}
...
{
    //  echo "Client£ºConnect. fd=$fd|from_id=$from_id\n";
}

function my_onReceive($serv, $fd, $from_id, $data)
{
    //  echo "Client£ºData. fd=$fd|from_id=$from_id|data=$data\n";
