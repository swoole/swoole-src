...
int dispatch_frame(const Protocol *proto, Socket *_socket, const RecvData *rdata) {
    ...
    char buf[SW_WEBSOCKET_HEADER_LEN + SW_WEBSOCKET_CONTROL_FRAME_PAYLOAD_MAX_LEN];
    send_frame.str = buf;
