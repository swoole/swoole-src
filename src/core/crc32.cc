...
static const unsigned int crc32tab[256] = { 0x00000000, 0x77073096, 0xee0e612c, 0x990951ba, 0x076dc419, 0x706af48f,
...
uint32_t swoole_crc32(const char *p, uint32_t nr) {
    uint32_t crcinit = 0;
