...
static void php_swoole_client_socket_free_socks5_proxy(swClient *cli)
{
    if (cli->socks5_proxy)
    {
...
static void php_swoole_client_socket_free_http_proxy(swClient *cli)
{
    if (cli->http_proxy)
    {
...
static void php_swoole_client_free(zval *zobject, swClient *cli)
{
    if (cli->timer)
    {
