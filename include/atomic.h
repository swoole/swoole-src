...
#define sw_atomic_fetch_or(value, orv)     __sync_fetch_and_or(value, orv)
#define sw_atomic_fetch_xor(value, xorv)   __sync_fetch_and_xor(value, xorv)
#define sw_atomic_fetch_and(value, andv)   __sync_fetch_and_and(value, andv)
#define sw_atomic_fetch_nand(value, nand) __sync_fetch_and_nand(value, nand)
#define sw_atomic_or_fetch(value, orv)     __sync_or_and_fetch(value, orv)
#define sw_atomic_xor_fetch(value, xorv)   __sync_xor_and_fetch(value, xorv)
#define sw_atomic_and_fetch(value, andv)   __sync_and_and_fetch(value, andv)
#define sw_atomic_nand_fetch(value, nand) __sync_nand_and_fetch(value, nand)
