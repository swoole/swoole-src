...
#define sw_atomic_load(value) \
    _InterlockedCompareExchange(reinterpret_cast<volatile LONG *>(value), 0, 0)
...
#define sw_atomic_load(value) __sync_val_compare_and_swap(value, 0, 0)
