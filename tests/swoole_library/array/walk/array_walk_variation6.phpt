--TEST--
swoole_library/array/walk: usage variations - 'input' argument as diff. associative arrays
--SKIPIF--
...
go(function(){
    ...
    // String keys
    $input = ["a" => "Apple", 'b' => 'Bananna', "c" => "carrot", 'o' => "Orange"];
    ...
    $input = [0 => 1, 1 => 2, "a" => "Apple", "b" => "Banana", 2 => 3];
