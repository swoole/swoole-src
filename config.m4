...
if test "$PHP_SWOOLE" != "no"; then
    ...
    AC_CHECK_LIB(c, CCRandomGenerateBytes, [
    	AC_DEFINE(HAVE_CCRANDOMGENERATEBYTES, 1, [have_ccrandomgeneratebytes])
        PHP_ADD_INCLUDE("/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include")
	])
