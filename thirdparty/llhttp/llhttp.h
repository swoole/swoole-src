...
enum swoole_http_error {
    PHP_HTTP_OK = HPE_OK,
    PHP_HTTP_INTERNAL = HPE_INTERNAL,
    PHP_HTTP_STRICT = HPE_STRICT,
    PHP_HTTP_CR_EXPECTED = HPE_CR_EXPECTED,
    PHP_HTTP_LF_EXPECTED = HPE_LF_EXPECTED,
    PHP_HTTP_UNEXPECTED_CONTENT_LENGTH = HPE_UNEXPECTED_CONTENT_LENGTH,
    PHP_HTTP_UNEXPECTED_SPACE = HPE_UNEXPECTED_SPACE,
    PHP_HTTP_CLOSED_CONNECTION = HPE_CLOSED_CONNECTION,
    PHP_HTTP_INVALID_METHOD = HPE_INVALID_METHOD,
    PHP_HTTP_INVALID_URL = HPE_INVALID_URL,
    PHP_HTTP_INVALID_CONSTANT = HPE_INVALID_CONSTANT,
    PHP_HTTP_INVALID_VERSION = HPE_INVALID_VERSION,
    PHP_HTTP_INVALID_HEADER_TOKEN = HPE_INVALID_HEADER_TOKEN,
    PHP_HTTP_INVALID_CONTENT_LENGTH = HPE_INVALID_CONTENT_LENGTH,
    PHP_HTTP_INVALID_CHUNK_SIZE = HPE_INVALID_CHUNK_SIZE,
    PHP_HTTP_INVALID_STATUS = HPE_INVALID_STATUS,
    PHP_HTTP_INVALID_EOF_STATE = HPE_INVALID_EOF_STATE,
    PHP_HTTP_INVALID_TRANSFER_ENCODING = HPE_INVALID_TRANSFER_ENCODING,
    PHP_HTTP_CB_MESSAGE_BEGIN = HPE_CB_MESSAGE_BEGIN,
    PHP_HTTP_CB_HEADERS_COMPLETE = HPE_CB_HEADERS_COMPLETE,
    PHP_HTTP_CB_MESSAGE_COMPLETE = HPE_CB_MESSAGE_COMPLETE,
    PHP_HTTP_CB_CHUNK_HEADER = HPE_CB_CHUNK_HEADER,
    PHP_HTTP_CB_CHUNK_COMPLETE = HPE_CB_CHUNK_COMPLETE,
    PHP_HTTP_PAUSED = HPE_PAUSED,
    PHP_HTTP_PAUSED_UPGRADE = HPE_PAUSED_UPGRADE,
    PHP_HTTP_PAUSED_H2_UPGRADE = HPE_PAUSED_H2_UPGRADE,
    PHP_HTTP_USER = HPE_USER,
    PHP_HTTP_CB_URL_COMPLETE = HPE_CB_URL_COMPLETE,
    PHP_HTTP_CB_STATUS_COMPLETE = HPE_CB_STATUS_COMPLETE,
    PHP_HTTP_CB_METHOD_COMPLETE = HPE_CB_METHOD_COMPLETE,
    PHP_HTTP_CB_VERSION_COMPLETE = HPE_CB_VERSION_COMPLETE,
    PHP_HTTP_CB_HEADER_FIELD_COMPLETE = HPE_CB_HEADER_FIELD_COMPLETE,
    PHP_HTTP_CB_HEADER_VALUE_COMPLETE = HPE_CB_HEADER_VALUE_COMPLETE,
    PHP_HTTP_CB_CHUNK_EXTENSION_NAME_COMPLETE = HPE_CB_CHUNK_EXTENSION_NAME_COMPLETE,
    PHP_HTTP_CB_CHUNK_EXTENSION_VALUE_COMPLETE = HPE_CB_CHUNK_EXTENSION_VALUE_COMPLETE,
    PHP_HTTP_CB_RESET = HPE_CB_RESET
};
typedef enum swoole_http_error swoole_http_error_t;
...
enum swoole_http_parser { PHP_HTTP_BOTH = HTTP_BOTH, PHP_HTTP_REQUEST = HTTP_REQUEST, PHP_HTTP_RESPONSE = HTTP_RESPONSE };
typedef enum swoole_http_parser swoole_http_parser_t;
...
enum swoole_http_method {
    PHP_HTTP_DELETE = HTTP_DELETE,
    PHP_HTTP_GET = HTTP_GET,
    PHP_HTTP_HEAD = HTTP_HEAD,
    PHP_HTTP_POST = HTTP_POST,
    PHP_HTTP_PUT = HTTP_PUT,
    PHP_HTTP_CONNECT = HTTP_CONNECT,
    PHP_HTTP_OPTIONS = HTTP_OPTIONS,
    PHP_HTTP_TRACE = HTTP_TRACE,
    PHP_HTTP_COPY = HTTP_COPY,
    PHP_HTTP_LOCK = HTTP_LOCK,
    PHP_HTTP_MKCOL = HTTP_MKCOL,
    PHP_HTTP_MOVE = HTTP_MOVE,
    PHP_HTTP_PROPFIND = HTTP_PROPFIND,
    PHP_HTTP_PROPPATCH = HTTP_PROPPATCH,
    PHP_HTTP_SEARCH = HTTP_SEARCH,
    PHP_HTTP_UNLOCK = HTTP_UNLOCK,
    PHP_HTTP_BIND = HTTP_BIND,
    PHP_HTTP_REBIND = HTTP_REBIND,
    PHP_HTTP_UNBIND = HTTP_UNBIND,
    PHP_HTTP_ACL = HTTP_ACL,
    PHP_HTTP_REPORT = HTTP_REPORT,
    PHP_HTTP_MKACTIVITY = HTTP_MKACTIVITY,
    PHP_HTTP_CHECKOUT = HTTP_CHECKOUT,
    PHP_HTTP_MERGE = HTTP_MERGE,
    PHP_HTTP_MSEARCH = HTTP_MSEARCH,
    PHP_HTTP_NOTIFY = HTTP_NOTIFY,
    PHP_HTTP_SUBSCRIBE = HTTP_SUBSCRIBE,
    PHP_HTTP_UNSUBSCRIBE = HTTP_UNSUBSCRIBE,
    PHP_HTTP_PATCH = HTTP_PATCH,
    PHP_HTTP_PURGE = HTTP_PURGE,
    PHP_HTTP_MKCALENDAR = HTTP_MKCALENDAR,
    PHP_HTTP_LINK = HTTP_LINK,
    PHP_HTTP_UNLINK = HTTP_UNLINK,
    PHP_HTTP_SOURCE = HTTP_SOURCE,
    PHP_HTTP_PRI = HTTP_PRI,
    PHP_HTTP_DESCRIBE = HTTP_DESCRIBE,
    PHP_HTTP_ANNOUNCE = HTTP_ANNOUNCE,
    PHP_HTTP_SETUP = HTTP_SETUP,
    PHP_HTTP_PLAY = HTTP_PLAY,
    PHP_HTTP_PAUSE = HTTP_PAUSE,
    PHP_HTTP_TEARDOWN = HTTP_TEARDOWN,
    PHP_HTTP_GET_PARAMETER = HTTP_GET_PARAMETER,
    PHP_HTTP_SET_PARAMETER = HTTP_SET_PARAMETER,
    PHP_HTTP_REDIRECT = HTTP_REDIRECT,
    PHP_HTTP_RECORD = HTTP_RECORD,
    PHP_HTTP_FLUSH = HTTP_FLUSH,
    PHP_HTTP_QUERY = HTTP_QUERY
};
typedef enum swoole_http_method swoole_http_method_t;
...
/* swoole */
void swoole_http_parser_init(llhttp_t *parser, swoole_http_parser_t type);
size_t swoole_http_parser_execute(llhttp_t *parser, const llhttp_settings_t *settings, const char *data, size_t len);
/* swoole */
