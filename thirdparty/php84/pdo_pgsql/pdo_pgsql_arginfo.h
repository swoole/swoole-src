...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Swoole_Pdo_Pgsql_escapeIdentifier, 0, 1, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO(0, input, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Swoole_Pdo_Pgsql_copyFromArray, 0, 2, _IS_BOOL, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Swoole_Pdo_Pgsql_copyFromFile, 0, 2, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, tableName, IS_STRING, 0)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_class_Swoole_Pdo_Pgsql_copyToArray, 0, 1, MAY_BE_ARRAY|MAY_BE_FALSE)
	ZEND_ARG_TYPE_INFO(0, tableName, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, separator, IS_STRING, 0, "\"\\t\"")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, nullAs, IS_STRING, 0, "\"\\\\\\\\N\"")
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, fields, IS_STRING, 1, "null")
...
#define arginfo_class_Swoole_Pdo_Pgsql_copyToFile arginfo_class_Swoole_Pdo_Pgsql_copyFromFile

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_class_Swoole_Pdo_Pgsql_lobCreate, 0, 0, MAY_BE_STRING|MAY_BE_FALSE)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(arginfo_class_Swoole_Pdo_Pgsql_lobOpen, 0, 0, 1)
	ZEND_ARG_TYPE_INFO(0, oid, IS_STRING, 0)
	ZEND_ARG_TYPE_INFO_WITH_DEFAULT_VALUE(0, mode, IS_STRING, 0, "\"rb\"")
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Swoole_Pdo_Pgsql_lobUnlink, 0, 1, _IS_BOOL, 0)
	ZEND_ARG_TYPE_INFO(0, oid, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_class_Swoole_Pdo_Pgsql_getNotify, 0, 0, MAY_BE_ARRAY|MAY_BE_FALSE)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Swoole_Pdo_Pgsql_getPid, 0, 0, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_class_Swoole_Pdo_Pgsql_setNoticeCallback, 0, 1, IS_VOID, 0)
	ZEND_ARG_TYPE_INFO(0, callback, IS_CALLABLE, 1)
ZEND_END_ARG_INFO()

ZEND_METHOD(Swoole_Pdo_Pgsql, escapeIdentifier);
ZEND_METHOD(Swoole_Pdo_Pgsql, copyFromArray);
ZEND_METHOD(Swoole_Pdo_Pgsql, copyFromFile);
ZEND_METHOD(Swoole_Pdo_Pgsql, copyToArray);
ZEND_METHOD(Swoole_Pdo_Pgsql, copyToFile);
ZEND_METHOD(Swoole_Pdo_Pgsql, lobCreate);
ZEND_METHOD(Swoole_Pdo_Pgsql, lobOpen);
ZEND_METHOD(Swoole_Pdo_Pgsql, lobUnlink);
ZEND_METHOD(Swoole_Pdo_Pgsql, getNotify);
ZEND_METHOD(Swoole_Pdo_Pgsql, getPid);
ZEND_METHOD(Swoole_Pdo_Pgsql, setNoticeCallback);

static const zend_function_entry class_Swoole_Pdo_Pgsql_methods[] = {
	ZEND_ME(Swoole_Pdo_Pgsql, escapeIdentifier, arginfo_class_Swoole_Pdo_Pgsql_escapeIdentifier, ZEND_ACC_PUBLIC)
	ZEND_ME(Swoole_Pdo_Pgsql, copyFromArray, arginfo_class_Swoole_Pdo_Pgsql_copyFromArray, ZEND_ACC_PUBLIC)
	ZEND_ME(Swoole_Pdo_Pgsql, copyFromFile, arginfo_class_Swoole_Pdo_Pgsql_copyFromFile, ZEND_ACC_PUBLIC)
	ZEND_ME(Swoole_Pdo_Pgsql, copyToArray, arginfo_class_Swoole_Pdo_Pgsql_copyToArray, ZEND_ACC_PUBLIC)
	ZEND_ME(Swoole_Pdo_Pgsql, copyToFile, arginfo_class_Swoole_Pdo_Pgsql_copyToFile, ZEND_ACC_PUBLIC)
	ZEND_ME(Swoole_Pdo_Pgsql, lobCreate, arginfo_class_Swoole_Pdo_Pgsql_lobCreate, ZEND_ACC_PUBLIC)
	ZEND_ME(Swoole_Pdo_Pgsql, lobOpen, arginfo_class_Swoole_Pdo_Pgsql_lobOpen, ZEND_ACC_PUBLIC)
	ZEND_ME(Swoole_Pdo_Pgsql, lobUnlink, arginfo_class_Swoole_Pdo_Pgsql_lobUnlink, ZEND_ACC_PUBLIC)
	ZEND_ME(Swoole_Pdo_Pgsql, getNotify, arginfo_class_Swoole_Pdo_Pgsql_getNotify, ZEND_ACC_PUBLIC)
	ZEND_ME(Swoole_Pdo_Pgsql, getPid, arginfo_class_Swoole_Pdo_Pgsql_getPid, ZEND_ACC_PUBLIC)
	ZEND_ME(Swoole_Pdo_Pgsql, setNoticeCallback, arginfo_class_Swoole_Pdo_Pgsql_setNoticeCallback, ZEND_ACC_PUBLIC)
	ZEND_FE_END
};

static zend_class_entry *register_class_Swoole_Pdo_Pgsql(zend_class_entry *class_entry_PDO)
{
	zend_class_entry ce, *class_entry;

	INIT_NS_CLASS_ENTRY(ce, "Pdo", "Pgsql", class_Swoole_Pdo_Pgsql_methods);
