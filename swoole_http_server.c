...
void swoole_http_server_init(int module_number TSRMLS_DC)
{
    ...
    zend_register_class_alias("Swoole\\Http\\Server", swoole_http_server_class_entry_ptr);
    ...
    zend_register_class_alias("Swoole\\Http\\Response", swoole_http_response_class_entry_ptr);
    ...
    zend_register_class_alias("Swoole\\Http\\Requset", swoole_http_request_class_entry_ptr);
